...
Public Class FormMain
    ...
    Protected Friend Function connectToDb() As SqlConnection
        Dim connectionString = "Server=.\SQLEXPRESS;Integrated Security=true;AttachDbFileName=D:\Fall 2016\NET\rleduc6_finalProject\rleduc6_finalProject\MayorData2.mdf"
